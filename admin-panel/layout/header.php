    ...
    <aside class="admin-sidebar" aria-label="Main navigation">
        ...
        <nav class="admin-sidebar__nav">
            ...
            <ul class="admin-nav-list">
                ...
                <li>
                    <a class="admin-nav-link" href="<?php echo ADMINURL; ?>/genres-admins/show-genres.html">
                        <span class="admin-nav-icon" aria-hidden="true">
                ...
                <li>
                    <a class="admin-nav-link" href="<?php echo ADMINURL; ?>/episodes-admins/show-episodes.html">
                        <span class="admin-nav-icon" aria-hidden="true">
